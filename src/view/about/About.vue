...
const cards = reactive([
    {
        ...
        description:
            'CAS蛋品之生產場(廠)其軟硬體設備與衛生管理均良好，且經專家評鑑合格，蛋品及生產場之飼料亦經中央畜產會檢驗合格。',
    },
    {
        id: '2',
        markName: '穀研所潔淨標章',
        ...
        description:
            '最高級的潔淨標章，完全不添加食品添加物，也不可額外添加天然香料、天然色素及使用加工助劑，是百分之百潔淨認證。',
    },
    {
        id: '3',
        markName: '動物福利標章',
        ...
        description:
            '標章認證的牧場尊重雞隻天性，絕不進行「強迫換羽」，每日紀錄及監控雞隻的健康，給予專業的飼養照顧。',
    },
])
</script>
    ...
    <div>
        ...
        <section class="certification">
            <div class="certification_inner">
                ...
                <p class="content">
                    善待動物並提供友善的飼養環境已經是普世的價值觀，消費者關心畜產品曾經受到何種對待，因此，會選擇標榜高動物福利之畜產品，進而使動物福利也成為產品的附加價值。
                </p>
        ...
        <section class="cluckdom_intro">
            ...
            <ul class="cluckdom_intro_inner">
                <li class="card_item">
                    ...
                    <p class="content">
                        我們選用通過 FSSC 22000
                        食品安全驗證的飼料，同時提高飼料配方中蛋白質的比例，<span
                            class="secondary_color"
                            >更添加金盞花與能增加抵抗力的多種植物精油，讓農場能達到全程「無抗生素飼養」。</span
                        >
                    </p>
                    <p class="content">
                        儘管成本較高，但也可避免因營養不良而出現脫羽和互啄等傷害。根據統計，母雞通常在70週齡後開始老化衰弱，但我們養的雞兒，至105週齡仍保持頭好壯壯、充滿活力！
                    </p>
                    <span class="info_source"
                        >資料參考來源：https://www.buydirectlyfromfarmers.tw/catalogue/Longtan-freerangeeggs-Chang_3989/
                    </span>
                </li>
                <li class="card_item">
                    <h2 class="card_title">照顧動物福利<br />鷄蛋吃得更安心</h2>
                    <p class="content">
                        我們每天收集牧場內剛下的新鮮雞蛋，並將它們置於<span
                            class="secondary_color"
                            >含有次氯酸水的布上輕輕擦拭，消除表面殘留的細菌和灰塵。</span
                        >待乾燥後，我們小心地將每一顆雞蛋包裝在紙漿盒中，然後安全地送到消費者手中。
                    </p>
                    <p class="content">
                        我們投入大量心力和成本來經營牧場，<span
                            class="secondary_color"
                            >建立符合動物保護法的人道生產標準，希望逐步改變消費者購買生鮮雞蛋的傳統模式</span
                        >，讓更多人支持友善雞蛋的生產。
                    </p>
                    <span class="info_source"
                        >資料參考來源：
                ...
                <li class="card_item">
                    ...
                    <p class="content">
                        想要了解更多關於養雞的知識嗎？別忘了追蹤我們的Instagram帳號，您將能夠獲得更多關於我們牧場的資訊、日常生活和養雞的專業知識。一起來探索雞蛋王國的世界吧！
                    </p>
        ...
        <section class="about_us_inner">
            <div class="text" data-aos="fade-right">
                ...
                <h2 class="title">
                    細心耕耘，不僅是美食
                    <br />
                    更是<span class="secondary_color">健康</span>與<span
                        class="secondary_color"
                        >自然</span
                    >的完美融合
                </h2>
                <div class="content">
                    <p>
                        目前雞場飼養約六萬隻雞，我們採用自動化系統管理飼料供應等工作，唯一仍然由人手操作的環節是雞蛋的收集。
                    </p>
                    <p>
                        我們深知環境對於雞蛋的品質影響重大，因此我們只使用純天然水及山海的恩惠，提供高品質同時，提供充滿快樂氣息的生長環境給我們的雞隻。
                    </p>
                </div>
            </div>
            <div class="img_owner">
